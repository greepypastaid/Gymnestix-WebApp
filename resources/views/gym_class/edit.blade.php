        ...
        <div class="bg-neutral-800 p-6 shadow sm:rounded-lg mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-white">Edit Gym Class</h1>
                        <p class="text-neutral-400">Update gym class information</p>
                    </div>
                </div>
            ...
            <form action="{{ route('gym_class.update', $gymClass->class_id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="trainer_id" id="trainer_id" class="block w-full px-3 py-2 border border-neutral-600 rounded-lg shadow-sm bg-neutral-700 text-white focus:outline-none focus:ring-2 focus:ring-[#ADFF2F] focus:border-[#ADFF2F]" value="{{ old('trainer_id', $gymClass->trainer_id) }}" required placeholder="Enter trainer ID">
                    </div>
                    <div>
