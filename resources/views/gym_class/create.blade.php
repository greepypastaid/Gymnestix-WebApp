...
<div class="min-h-screen bg-[#0a0a0a] p-4 md:p-8">
    <div class="w-full mx-auto">
        ...
        <div class="card-dark p-6">
            <form action="{{ route('gym_class.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="ruangan" id="ruangan" class="input-dark w-full" value="{{ old('ruangan') }}" placeholder="e.g. Studio A, Gym Hall">
                </div>
