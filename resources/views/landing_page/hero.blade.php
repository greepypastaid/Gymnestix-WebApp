<div class="relative min-h-screen text-white overflow-hidden">
    <div class="absolute h-screen w-full">
        <img src="{{ asset('images/Hero.png') }}" alt="Hero background" class="w-full h-screen object-cover" loading="lazy" decoding="async">
    ...
    <div class="relative z-10 min-h-screen flex items-center">
        <div class="max-w-7xl w-full mx-auto item-left">
            <!-- Hero Section -->
            <div class="max-w-3xl">
                <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-nunito text-white leading-tight">
                    Kembangkan Dirimu di Gymnestix
                </h1>
                <p class="mt-6 text-neutral-300 font-poppins text-base sm:text-lg">
                ...
                <div class="flex flex-col sm:flex-row gap-3 mt-8 sm:mt-12 md:mt-16 lg:mt-24">
                    <a href="#daftar"
                ...
                <div class="max-w-md sm:max-w-sm w-full grid grid-cols-2 gap-3 mt-8 sm:mt-12 text-white text-sm">
