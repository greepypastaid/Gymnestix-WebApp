        ...
        <div class="bg-neutral-800 p-4 sm:p-6 shadow sm:rounded-lg mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-white">Add New Equipment</h1>
                        <p class="text-sm text-neutral-400 hidden sm:block">Create a new equipment record</p>
                    </div>
                </div>
                <a href="{{ route('admin.equipment.index') }}" class="w-full sm:w-auto px-4 py-2 bg-neutral-600 text-white rounded-lg hover:bg-neutral-500 font-medium flex items-center justify-center space-x-2 transition duration-200">
