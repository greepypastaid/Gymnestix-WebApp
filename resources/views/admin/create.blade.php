        ...
        <div class="card-header">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <div class="subtitle">Create a new user or member account</div>
                </div>
            </div>
            <div class="ml-auto">
            ...
            <form action="{{ route('admin.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nama" id="nama" class="input-dark w-full" required value="{{ old('nama') }}" placeholder="Enter full name">
                    </div>
                    <div>
                        <label for="email" class="block text-sm font-medium text-white mb-2">Email</label>
                        <input type="email" name="email" id="email" class="input-dark w-full" required value="{{ old('email') }}" placeholder="user@example.com">
                    </div>
                    <div>
                        <label for="password" class="block text-sm font-medium text-white mb-2">Password</label>
                        <input type="password" name="password" id="password" class="input-dark w-full" required placeholder="Min. 8 characters">
                    </div>
                    <div>
                        <label for="nomor_telepon" class="block text-sm font-medium text-white mb-2">Nomor Telepon</label>
                        <input type="text" name="nomor_telepon" id="nomor_telepon" class="input-dark w-full" required value="{{ old('nomor_telepon') }}" placeholder="08123456789">
                    </div>
                    <div>
                        <label for="tanggal_lahir" class="block text-sm font-medium text-white mb-2">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="input-dark w-full" required value="{{ old('tanggal_lahir') }}">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3" class="input-dark w-full" required placeholder="Enter full address">{{ old('alamat') }}</textarea>
                </div>
